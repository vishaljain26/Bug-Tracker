<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="WebForm10.aspx.cs" Inherits="bug_tracker.WebForm10" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
<div>

      <asp:Panel ID="Panel1" runat="server" BorderStyle="Inset" Height="795px" 
        style="margin-bottom: 0px">
          <asp:Table ID="Table1" runat="server"  CellSpacing="0" CellPadding="4"
            ...
            <asp:TableRow>
                ...
                <asp:TableCell BorderWidth="1" Width="232px" Font-Bold="true" BackColor="Aqua">Attached File</asp:TableCell><asp:TableCell
                    BorderWidth="1" Width="1255px" ID="file" BackColor="White" Font-Bold="false" ColumnSpan="5"><asp:TextBox ID="TextBox20" runat="server" ReadOnly="true" BackColor="LightGray" 
            style="z-index: 1; position: relative;width:99.5%"></asp:TextBox></asp:TableCell></asp:TableRow>
    ...
    <asp:Panel ID="Panel2" runat="server" BorderStyle="Ridge" BorderColor="Black" 
            ...
            style="z-index: 1; left: 3px; top: 550px; position: absolute; height: 26px; width: 1489px">
