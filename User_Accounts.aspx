<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true"
    CodeBehind="User_Accounts.aspx.cs" Inherits="bug_tracker.WebForm8" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="height: 100%; width: 150%">
        ...
        <asp:ImageButton ID="ImageButton6" runat="server" 
            style="position:absolute; top: 197px; left: 1013px; width: 147px; height: 44px;" 
            ImageUrl="~/Styles/wall-create-account-button.png" 
            PostBackUrl="~/New_User.aspx"/>
    </div>
</asp:Content>
