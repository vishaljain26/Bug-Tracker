<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Delete_User.aspx.cs" Inherits="bug_tracker.WebForm11" %>
...
<asp:Panel ID="Panel2" runat="server" 
    ...
    <br />
        ...
        <asp:TableCell Width="600px" ColumnSpan="1" BorderWidth="1" BackColor="White">
            <asp:TextBox ID="TextBox1" runat="server" style="z-index:1; width:50%;position:relative;height:98%" TabIndex="1" ReadOnly="true" BackColor="LightGray"></asp:TextBox>
        </asp:TableCell>
        </asp:TableRow>
        <asp:TableRow BorderStyle="None" BorderColor="Black">
        ...
        <asp:TableCell Width="600px" ColumnSpan="1" BorderWidth="1" BackColor="White">
            <asp:TextBox ID="TextBox2" runat="server" style="z-index:1; width:50%;position:relative;height:98%" TabIndex="2" ReadOnly="true" BackColor="LightGray"></asp:TextBox>
        </asp:TableCell>
        </asp:TableRow>
        <asp:TableRow BorderStyle="None" BorderColor="Black">
        ...
        <asp:TableCell Width="600px" ColumnSpan="1" BorderWidth="1" BackColor="White">
            <asp:TextBox ID="TextBox3" runat="server" style="z-index:1; width:50%;position:relative;height:98%" TabIndex="3" ReadOnly="true" BackColor="LightGray"></asp:TextBox>
        </asp:TableCell>
        </asp:TableRow>
        <asp:TableRow BorderStyle="None" BorderColor="Black">
        ...
        <asp:TableCell Width="600px" ColumnSpan="1" BorderWidth="1" BackColor="White">
            <asp:TextBox ID="TextBox4" runat="server" style="z-index:1; width:50%;position:relative;height:98%" TabIndex="4" ReadOnly="true" BackColor="LightGray"></asp:TextBox>
        </asp:TableCell>
        </asp:TableRow>
        <asp:TableRow BorderStyle="None" BorderColor="Black">
        ...
        <asp:TableCell Width="600px" ColumnSpan="1" BorderWidth="1" BackColor="White">
            <asp:TextBox ID="TextBox5" runat="server" style="z-index:1; width:50%;position:relative;height:98%" TabIndex="5" ReadOnly="true" BackColor="LightGray"></asp:TextBox>
        </asp:TableCell>
        </asp:TableRow>
