<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm2.aspx.cs" Inherits="bug_tracker.WebForm2" %>
...
<body style="background-color: #D4DAE9;" onload="OnWindowLoad()">
    ...
    <div runat="server">
        ...
        <asp:TextBox ID="TextBox1" runat="server" Style="z-index: 1; left: 643px; top: 357px;
            position: absolute; width: 241px" TabIndex="1"></asp:TextBox>
        <asp:TextBox ID="TextBox2" runat="server" Style="z-index: 1; left: 643px; top: 388px;
            position: absolute; width: 239px" TextMode="Password" TabIndex="2"></asp:TextBox>
        ...
        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/WebForm4.aspx" Style="z-index: 1;
