<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true"
    CodeBehind="New_User.aspx.cs" Inherits="bug_tracker.WebForm1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 <div style="height: 100%"  >
   <%--<script language="javascript" type="text/javascript">
    ...
    <asp:Panel ID="Panel1" runat="server" Width="70%" Height="41%"  
        BorderStyle="Solid" Visible="true" 
        style="margin-top: 0px ; margin-left: 300px" TabIndex="1" 
         BackColor="#d9eef7" BorderColor="#003366" DefaultButton="Button1" 
         oninit="Panel1_Init" >
        <asp:Label ID="Label1" runat="server" Text="Enter New User Details" 
            style="position:absolute; top: 19px; left: 1045px; width: 251px;" 
            Font-Bold="True" Font-Size="Larger" ForeColor="Red"></asp:Label>

        <asp:Label ID="Label4" runat="server" Font-Bold="True" 
        style="z-index: 1; left: 380px; top: 19px; position: absolute; height: 18px; margin-top: 0px; margin-left: 0px; width: 93px; right: 1027px;" 
        ...
        <asp:Label ID="Label12" runat="server" Font-Bold="True" 
            ...
            style="z-index: 1; left: 586px; top: 191px; position: absolute; height: 21px; width: 350px" 
            TabIndex="6">
        ...
        style="z-index: 1; left: 586px; top: 294px; position: absolute; width: 204px; margin-top: 0px; margin-left: 0px; height: 21px; right: 710px;" 
        TabIndex="9">
        <asp:ListItem>Viewer</asp:ListItem>
        <asp:ListItem>Admin</asp:ListItem>
        <asp:ListItem>Reporter</asp:ListItem>
    ...
    <asp:Label ID="Label11" runat="server" Font-Bold="True" 
        ...
        <br />
            ...
            style="position:absolute; top: 60px; left: 959px; height: 330px; width: 374px;" 
            ImageUrl="~/Styles/image/bugslifewallpaper800.jpg"/>
