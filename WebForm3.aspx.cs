        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            //{
                ...
                using (SqlConnection cmd = new SqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["ApplicationServices"].ToString()))
                {
                    ...
                    SqlCommand cn = new SqlCommand("insert into new_bug(date_submitted,priority,severity,reproducibility,platform,os,os_version,summary,description,steps_to_reproduce,additional_information,status,reporter,filename) values('" + TextBox2.Text + "','" + DropDownList1.SelectedItem.Text + "','" + DropDownList2.SelectedItem.Text + "','" + DropDownList3.SelectedItem.Text + "','" + TextBox3.Text + "','" + TextBox4.Text + "','" + TextBox5.Text + "','" + TextBox6.Text + "','" + TextBox7.Text + "','" + TextBox8.Text + "','" + TextBox9.Text + "',DEFAULT,'" + abc + "','"+FileUpload1.FileName+"')", cmd);
                    cn.ExecuteNonQuery();
