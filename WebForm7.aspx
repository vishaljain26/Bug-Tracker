<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="WebForm7.aspx.cs" Inherits="bug_tracker.WebForm7" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:GridView ID="GridView3" runat="server" 
        ...
        <Columns>
            ...
            <asp:HyperLinkField ItemStyle-Width="10%" DataNavigateUrlFields="id" DataNavigateUrlFormatString="WebForm9.aspx?id={0}" DataTextField="id" ItemStyle-HorizontalAlign="Center" />
         ...
         <asp:GridView ID="GridView5" runat="server" 
             ...
             <Columns>
                  <asp:HyperLinkField ItemStyle-Width="10%" DataNavigateUrlFields="id" 
                    DataNavigateUrlFormatString="WebForm9.aspx?id={0}" DataTextField="id" 
