<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Change_Status1.aspx.cs" Inherits="bug_tracker.WebForm13" %>
...
<asp:CheckBox ID="CheckBox2" runat="server">
    </asp:CheckBox><label runat="server">Check to Change</label>
</asp:TableCell>
</asp:TableRow>
<asp:TableRow>
...
<asp:Button ID="Button1" runat="server"  
        style="position: absolute; top: 303px; left: 604px; width: 165px; height: 33px;" 
